...
export function CartPage() {
  ...
  if (cartItems.length === 0) {
    return (
      <>
        <Helmet>
          <title>Carrinho Vazio | Brechó do Futuro</title>
          <meta
            name="description"
            content="Seu carrinho está vazio. Continue comprando no Brechó do Futuro."
          />
  ...
  return (
    <>
      <Helmet>
        <title>Carrinho | Brechó do Futuro</title>
        <meta
          name="description"
          content="Seu carrinho de compras. Adicione mais itens para finalizar sua compra."
        />
